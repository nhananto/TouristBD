...
.card:hover {
  box-shadow: 5px 10px 20px 3px rgba(0,0,0,0.7);
}
...
<div style="width:200px; font-size:18px; color:#1c9b8e; float:left">
...
<tr><td colspan="3" style="padding-bottom: 10px;"><span class="middletext" >Pack Name:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $data[1];?></td></tr> 
...
<?php echo $data[10];?> -->
<tr><td class="" ><div class="card"><img src="Admin/packimages/<?php echo $data[5];?>" alt="Avatar" width="200px" height="200px" ></div></td>
<td class=""  style="padding-left:15px"><div class="card"><img src="Admin/packimages/<?php echo $data[6];?>" alt="Avatar" width="200px" height="200px" ></div></td>
<td class="" style="padding-left:15px"><div class="card"><img src="Admin/packimages/<?php echo $data[7];?>" alt="Avatar" width="200px" height="200px" ></div></td>
</tr>
...
<tr><td align="left" colspan="3" height="50px"><a href="enquiry.php?pid=<?php echo $data[0];   ?>"><input type="button" value="Enquiry" name="sbmt" class="btnsbmt" /></a></td></tr>
</table>
</td>
</tr>
</table>
