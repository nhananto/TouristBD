		...
		<td class="lefttxt">
			<table border="0" width="100px" height="200px">
				<tr>
					...
					<td><label>UserName</label><input type="text" name="t1" title"Please Enter Only Characters between 1 to 50 for User Name" /></td>
				</tr>
				<tr>
					
					<td><label>Password</label><input type="password" name="t2" title"Please Enter Only Characters between 1 to 10 for Password" /></td>
				</tr>
				<tr>
					<td align="center" class="btn-submit"><input type="submit" value="LOGIN" name="sbmt" /></td>
				</tr>
			</table>
		</td>
