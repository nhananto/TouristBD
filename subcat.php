...
<tr><td style="font-size:20px; font-family:Helvetica; color:#1c9b8e"><b>Category</b></td></tr>
<?php
...
<tr><td class="image"><div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="Admin/subcatimages/<?php echo $data[3]; ?>" alt="Avatar" style="width:300px;height:300px;">
    </div>
    <div class="flip-card-back">
      <br><br><h3 style="font-family: Arial, Helvetica, sans-serif; color:black"><?php echo $data[1];?></h3> <br><br><br><br>

	  <a href="package.php?subcatid=<?php echo $data[0];?>"><input type="button" value="View Detail" name="sbmt" class="btnsbmt" /></a>
    </div>
  </div>
</div></td></tr><br/><br/>
