...
<body>
	...
	<div class="about section" id="section-2">
		...
		<div class="container">
			<div class="col-md-4 about-grids">
				...
				<h4 style="font-weight: bold;"><i class="fas fa-map-marker-alt"></i>Our Vision</h4>
				<p style="color:#343E46;">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptas, distinctio excepturi nostrum commodi laboriosam similique repudiandae impedit libero, soluta cum esse dolorem dolor iusto facilis.</p>
			</div>
			<div class="col-md-4 about-grids grid2">
				<h4 style="font-weight: bold;"><i class="fas fa-shield-alt"></i>Our Mission</h4>
				<p style="color:#343E46;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Est ab maiores cumque et tempore sed voluptas culpa aperiam.</p>
			</div>
			<div class="col-md-4 about-grids">
				<h4 style="font-weight: bold;"><i class="far fa-star"></i>Safety Information</h4>
				<p style="color:#343E46;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis asperiores quidem ea delectus rem dolore ipsum necessitatibus nesciunt adipisci iure.</p>
				<div align="right"><a href="aboutus.php"><input type="button" value="Read More" name="sbmt" class="btnsbmt" /></a></div>
		...
		<div id="portfolio" class="portfolio">
			...
			<div id="portfoliolist">
				<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t1.jpg" class="img-responsive" alt="t1" width="200px" height="200px" /></a>
					</div>
				</div>
				<div class="portfolio app mix_all" data-cat="app" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t2.jpg" class="img-responsive" alt="t2" width="200px" height="200px"/></a>
					</div>
				</div>
				<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t3.jpg" class="img-responsive" alt="" width="200px" height="200px"/></a>
				...
				<div class="portfolio icon mix_all" data-cat="icon" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t4.jpg" class="img-responsive" alt="" width="200px" height="200px"/></a>
				...
				<div class="portfolio card mix_all" data-cat="card" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t5.jpg" class="img-responsive" alt="" width="200px" height="200px"/></a>
				...
				<div class="portfolio fun mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t6.jpg" class="img-responsive" alt="" width="200px" height="200px"/></a>
				...
				<div class="portfolio fun mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t7.jpg" class="img-responsive" alt="" width="200px" height="200px"/></a>
				...
				<div class="portfolio icon mix_all" data-cat="fun" style="display: inline-block; opacity: 1;">
					<div class="portfolio-wrapper wow bounceIn" data-wow-delay="0.4s">
						<a href="#" class="b-link-stripe b-animate-go  thickbox play-icon popup-with-zoom-anim">
							<img src="images/t8.jpg" class="img-responsive" alt="" width="200px" height="200px" /></a>
	...
	<div class="tour-guides section" id="section-4"  style="margin-bottom: 0px;">
		<div class="tour-guides-head text-center">
			<h3 style="font-weight: bold;">Advertisements</h3>
			<span></span><img src="images/guide.png" alt=""><span></span>
			<div class="container">
				<p style="color:#343E46;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae, hic libero? Corrupti quisquam voluptate, non, sapiente itaque quo dolor eligendi ea nobis, facilis laborum? Facere.</p>
			</div>
		</div>
		<div class="container">
			...
			<div class="contact-grids">
				<div class="container">
					<div class="col-md-4 address">
						<h4 style="color:#1c9b8e">LOREM Enterprises</h4>
						<p style="color:#000">NEED HELP BOOKING PACKAGE<br />
							For fantastic suggestions you may also call our travel expert</p>
						<h5 style="color:#000"><span class="img1"></span>(+880) 1724589631&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;(+880) 1648521479</h5>
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@mytour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@mytour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span> Dhaka, Bangladesh</h5>
						<br />
						<img src="images/contact1.jpg" width="250px" height="260px" />
					</div>
